...
<div class="wrap">
    <div class="main-content wrap">
        ...
        <form id="write-form" autocomplete="off" enctype="multipart/form-data">
            ...
            <canvas id="canvas" class="my-img" width="945" height="600"></canvas>
