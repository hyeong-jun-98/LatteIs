...
public class FileUtils {
    ...
    public static String uploadFile(MultipartFile file, String uploadPath) {
        ...
        // 업로드 경로를 변경
        // E:/sl_djp/upload -> E:/sl_djp/upload/2022/08/01
        ...
        // 풀경로 - 루트경로 문자열 생성
        // full-path => E:/sl_djp/upload/2022/08/01/dfsdjfksfdkjs_상어.jpg
    ...
    // 한자리수 월, 일 정보를 항상 2자리로 만들어주는 메소드
    private static String len2(int n) {
        return new DecimalFormat("00").format(n);
    }

    // 파일명을 받아서 확장자를 반환하는 메소드
